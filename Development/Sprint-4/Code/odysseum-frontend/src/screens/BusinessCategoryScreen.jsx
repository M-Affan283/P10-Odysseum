...
const getQueryCategoryBusinesses = async ({
  pageParam = 1,
  locationId,
  category,
  searchParam,
  ...
  try {
    const res = await axiosInstance.get(
      `/business/getByCategoryAndLocation?locationId=${locationId}&category=${category}&page=${pageParam}&searchParam=${searchParam}`
    );
    return res.data;
  } catch (error) {
    console.log(error);
            ...
            return (
              <View className="flex-1 mt-12 justify-center items-center">
                ...
                <Text className="mt-4 text-white/70 font-medium">
                  Discovering {category} businesses...
                </Text>
              </View>
            );
          } else if (error) {
            ...
            return (
              <View className="flex-1 mt-12 justify-center items-center">
                <Text className="text-lg text-white/70 font-medium">
                  No {category} business found for "{debouncedSearchQuery}"
                </Text>
              </View>
            );
            ...
            return (
              <View className="flex-1 mt-12 justify-center items-center">
                ...
                <Text className="text-lg text-white/70 font-medium mt-4">
                  No {category} businesses found in this area
                </Text>
              </View>
            );
          }
