import { View, Text, Image, FlatList, TouchableOpacity, ImageBackground, Dimensions } from 'react-native'
        ...
        :
          <View>
            <View className="items-center mt-5">
                <ImageBackground source={{uri: userToView?.profilePicture}} style={{width: 150, height: 150, marginHorizontal:10}} imageStyle={{borderRadius: 100}}>
                ...
                <View className="items-center mt-5 gap-2">
                    ...
                    <TouchableOpacity onPress={()=> setUpdateBio(true)}>
                        <Text style={{fontSize: 15, color: "rgba(255,255,255,0.6)",}}>{userToView?.bio || "Add a bio"}</Text>
                    </TouchableOpacity>
                </View>
            </View>
