...
const CalendarModal = ({ visible, setVisible, setDate }) => {
        ...
        <View className="flex-1">
            ...
            >
                ...
                <View className="flex-row items-center justify-between gap-x-3">
                    ...
                    <Text className="text-white text-3xl font-dsbold p-4 mt-2">Select Date</Text>
                ...
                <View className="justify-center bg-[#101f36] rounded-2xl h-[65%]">
                    ...
                    <Calendar
                        ...
                        markedDates={{
                            [selectedDate?.toISOString().slice(0, 10)]: {selected: true, selectedColor: '#b919e7'}
                        }}
                        theme={{
                ...
                <View className="flex-row justify-center items-center gap-x-4 mt-4">
                    ...
                    <Text className="text-white text-lg">{selectedDate?.toDateString()}</Text>
                </View>

                <TouchableOpacity className="bg-[#8C00E3] mx-auto w-1/2 min-h-[50px] rounded-md flex-row justify-center items-center mt-5" onPress={onClose}>
